...
const SettingsPage = ({ language, setLanguage }) => {
    ...
    return (
        <div className="min-h-screen mt-16 transition-colors duration-300 bg-gray-50 text-gray-900 dark:bg-[#121212] dark:text-gray-100">
            <ScrollToTop />
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                {/* Account Settings */}
                <div className="rounded-xl shadow-lg mb-6 p-6 transition-colors bg-white dark:bg-[#1e1e1e]">
                    ...
                    <div className="space-y-4">
                        {["currentPassword", "newPassword", "confirmPassword"].map((field) => (
                            <input
                                ...
                                className="w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:border-[#ff8c96] dark:bg-[#2a2a2a] dark:border-gray-700 dark:text-white"
                            />
                        ))}
                        <button
                  ...
                  after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full peer-checked:after:border-white">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <select
                                ...
                                className="p-2 rounded-lg border border-gray-300 focus:outline-none focus:border-[#ff8c96] dark:bg-[#2a2a2a] dark:border-gray-700 dark:text-white"
                            >
