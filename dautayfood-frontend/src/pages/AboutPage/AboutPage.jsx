...
const AboutUsPage = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-[#D4ECE0] to-[#FF8080] font-sans text-gray-800">
            <ScrollToTop />
          ...
          ${isVisible("hero")
                ...
                <div className="relative z-10 max-w-3xl text-white">
                    ...
                    <div className="mt-6 flex flex-wrap justify-center gap-4">
                        <Link to="/menu#search-linking">
                            <button className="bg-white text-[#FF8080] font-semibold rounded-full px-6 py-3 shadow-md hover:bg-[#ffeaea] hover:-translate-y-1 transition-all">
                                Đặt hàng ngay
                            </button>
                        </Link>
                        <Link to="/menu#search-linking">
                            <button className="border-2 border-white text-white font-semibold rounded-full px-6 py-3 hover:bg-white hover:text-[#FF8080] hover:-translate-y-1 transition-all">
                                Xem menu
                            </button>
                        </Link>
                    </div>
            ...
            <section
                id="story"
                data-animate
                className={`max-w-6xl mx-auto px-4 py-16 ${isVisible("story")
                    ? "opacity-100 translate-y-0 transition-all duration-700"
                    : "opacity-0 translate-y-12 transition-all duration-700"
                    }`}
            >
                <div className="text-center">
                    ...
                    <div className="w-24 h-1 bg-gradient-to-r from-[#D4ECE0] to-[#FF8080] mx-auto my-4 rounded"></div>
                </div>

                <div className="grid md:grid-cols-2 gap-8 mt-12">
                    <div className="flex flex-col gap-6">
                        <div className="bg-[#D4ECE0] p-6 rounded-xl shadow-md hover:-translate-y-1 transition-transform">
                        ...
                        <div className="bg-[#FF8080] text-white p-6 rounded-xl shadow-md hover:-translate-y-1 transition-transform">
                    ...
                    <div className="flex flex-col gap-6">
                        {[
                            { icon: <Heart />, title: "Chất lượng đầu tiên", desc: "Cam kết nguyên liệu tươi ngon", bg: "bg-[#D4ECE0]" },
                            { icon: <Users />, title: "Phục vụ tận tâm", desc: "Giao hàng nhanh chóng, chu đáo", bg: "bg-[#FF8080] text-white" },
                            { icon: <Award />, title: "Giá cả hợp lý", desc: "Phù hợp với mọi đối tượng", bg: "bg-[#D4ECE0]" },
                        ].map((item, idx) => (
                            <div key={idx} className="flex flex-col items-center text-center bg-white p-6 rounded-xl shadow-md hover:scale-105 transition-transform">
            ...
            <section
                id="products"
                data-animate
                className={`max-w-6xl mx-auto px-4 py-16 ${isVisible("products")
                    ? "opacity-100 translate-y-0 transition-all duration-700"
                    : "opacity-0 translate-y-12 transition-all duration-700"
                    }`}
            >
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                    {[
                        ...
                        <div key={idx} className="bg-white p-6 rounded-2xl text-center shadow-md hover:scale-105 transition-transform">
                            <div className="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-4 bg-[#D4ECE0] text-[#FF8080] text-4xl">
                            ...
                            <div className="flex items-center justify-center gap-1 mt-3 text-yellow-400">
                                ...
                                <span className="ml-1 text-gray-600 text-sm">{p.rating}</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <section
                id="values"
                data-animate
                className={`max-w-6xl mx-auto px-4 py-16 ${isVisible("values")
                    ? "opacity-100 translate-y-0 transition-all duration-700"
                    : "opacity-0 translate-y-12 transition-all duration-700"
                    }`}
            >
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 text-center">
                    {[
                        ...
                        <div key={idx} className="bg-white p-6 rounded-xl shadow-md hover:-translate-y-1 transition-transform">
                            <div className="w-16 h-16 rounded-full bg-[#FF8080] flex items-center justify-center text-white mx-auto mb-3">
                                {v.icon}
                            </div>
