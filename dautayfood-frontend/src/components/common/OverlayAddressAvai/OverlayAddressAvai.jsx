...
const OverlayAddressList = ({ onSelect, onClose }) => {
    ...
    return (
        ...
        >
            <div className="overlay-bg w-[95%] sm:w-[90%] md:w-[642px] max-h-[90vh] 
                bg-white dark:bg-gray-900 rounded-lg shadow-xl flex flex-col relative text-gray-800 dark:text-gray-100">
                ...
                {/* Title */}
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 dark:text-gray-100 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        savedAddresses.map((address, index) => (
                            <div
                                ...
                                className="p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg 
                                    bg-white dark:bg-gray-800 hover:border-blue-500 hover:bg-blue-50 
                                    dark:hover:bg-gray-700 transition transform hover:-translate-y-1 
                            ...
                            >
                                <div onClick={() => handleSelect(address)}>
                                    ...
                                    <p className="inline-block mt-2 text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900 px-2 py-1 rounded">
                                        Loại:{" "}
                                ...
                                {/* Actions */}
                                <div className="flex flex-row gap-6 text-gray-700 dark:text-gray-300 mt-3">
                                    <span
                                    ...
                                    <span
                                        className="flex items-center gap-1 text-sm cursor-pointer hover:text-red-600 dark:hover:text-red-400"
                ...
                <div className="px-4 sm:px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-b-lg">
                    <button
