            ...
            <div className="flex flex-col gap-4 px-6 md:px-20 pt-6">
                ...
                <div className="border-t border-white/20 pt-4 flex flex-col md:flex-row justify-center md:gap-32 text-base text-white">
                    <ul className="mb-4 md:mb-0 min-w-[160px]">
                        <li className="mb-2"><Link to="/terms#faq">Câu hỏi thường gặp</Link></li>
                        <li className="mb-2"><Link to="/terms#privacy">Chính sách bảo mật</Link></li>
                        <li className="mb-2"><Link to="/terms#terms">Điều khoản sử dụng</Link></li>
                    </ul>
                    <ul className="mb-4 md:mb-0 min-w-[160px]">
                        <li className="mb-2"><Link to="/terms#payment">Chính sách thanh toán</Link></li>
                        <li className="mb-2">Khuyến mãi</li>
                        <li className="mb-2"><Link to="/terms#delivery">Chính sách giao hàng</Link></li>
                    </ul>
                    <ul className="min-w-[160px]">
                        <li className="mb-2"><Link to="/terms#user-rules">Quy định người dùng</Link></li>
                        <li className="mb-2"><Link to="/terms#refund">Chính sách đổi trả</Link></li>
                        <li className="mb-2"><Link to="/terms#contact">Thông tin liên hệ</Link></li>
                    </ul>
                </div>
