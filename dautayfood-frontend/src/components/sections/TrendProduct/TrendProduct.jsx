    ...
    return (
        <div
            className="
                ...
                p-8 flex flex-col items-center mx-auto my-10 max-w-[90%] shadow-md 
        ...
        >
            ...
            <div className="flex items-center mb-8 w-full justify-center flex-wrap">
                ...
                <div
                    className="
                        max-w-[600px] bg-white/40 dark:bg-gray-700/40
                        p-5 rounded-2xl italic text-base text-gray-800 dark:text-gray-200
                        leading-relaxed shadow-md transition-colors duration-500
                    "
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-10">
                {TopProducts.map((item, index) => (
                    <div key={item.id || index} className="relative flex flex-col items-center">
                        ...
                        <div
                            className={`
                                w-[50px] h-[50px] rounded-full text-[22px] font-bold text-white 
                                flex items-center justify-center absolute -top-5 z-10
